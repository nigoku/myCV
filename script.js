...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const jokes = [
      "Чому курка хакнула сайт? Бо вона яйця в код зашила!",
      "Моя бабця борщ варила, а ложка в тарілці тікток знімала!",
      ...
      "Чому огірок у холодильнику співав? Бо він маринад-попстар!",
      "Кібербезпека: коли антивірус гавкає голосніше, ніж сусідський пес.",
      "Дід до баби: 'Твій борщ — як SQL-ін’єкція, прямо в серце!'",
      "Чому корова стала блогером? Бо мучила всіх в Instagram!",
      "UI/UX дизайнер до хакера: 'Твій експлойт — не по фен-шую!'",
